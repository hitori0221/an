...
type DropdownMenuItemProps = DropdownMenuItemPrimitiveProps & {
  inset?: boolean;
  variant?: 'default' | 'destructive' | 'hardDelete';
};
  ...
  return (
    ...
    >
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          "focus:text-accent-foreground data-[variant=destructive]:text-destructive data-[variant=destructive]:focus:text-destructive data-[variant=destructive]:*:[svg]:!text-destructive data-[variant=hardDelete]:text-violet-600 data-[variant=hardDelete]:focus:text-violet-700 data-[variant=hardDelete]:*:[svg]:!text-violet-600 dark:data-[variant=hardDelete]:text-violet-400 dark:data-[variant=hardDelete]:focus:text-violet-300 dark:data-[variant=hardDelete]:*:[svg]:!text-violet-400 [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          className,
        )}
        {...props}
      />
