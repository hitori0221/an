...
export const getInstallationColumns = ({
  ...
  },
  {
    ...
    accessorKey: 'plan',
    cell: ({ row }) => (
      <span className='inline-flex h-6 max-w-full items-center rounded-md bg-muted/70 px-2 text-xs font-medium leading-tight text-foreground'>
        {row.getValue('plan')}
      </span>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <span className='block truncate leading-tight text-muted-foreground'>{row.original.barangay}, {row.original.city}</span>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className='block truncate leading-tight text-muted-foreground'>{row.getValue('scheduleDate')}</span>
    ),
  },
  {
