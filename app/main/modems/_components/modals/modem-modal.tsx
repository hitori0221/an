      ...
      <DialogContent className='flex max-h-[calc(100dvh-2rem)] max-w-[520px] flex-col gap-0 overflow-hidden p-0 sm:max-h-[calc(100dvh-4rem)]'>
        ...
        <div className='grid flex-1 gap-4 overflow-y-auto px-6 py-4'>
          <div className='grid gap-3 sm:grid-cols-[150px_1fr]'>
            ...
            <div className='grid gap-1.5'>
              <label className='text-[13px] font-medium sm:text-sm' htmlFor='modem-name'>
                Modem name
              </label>
              <Input
                id='modem-name'
          ...
          <div className='grid gap-1.5'>
            <label className='text-[13px] font-medium sm:text-sm' htmlFor='modem-status'>
              Status
            </label>
            <Select
              value={form.status}
              onValueChange={(value) =>
                setForm((current) => ({ ...current, status: value as ModemStatus }))
              }
            >
              <SelectTrigger id='modem-status' className='h-10 w-full bg-background/40'>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
